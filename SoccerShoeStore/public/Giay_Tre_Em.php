        ...
        <div id="main">
            ...
            <?php include 'includes/sidebar.php'; ?> <!-- Sidebar lọc sản phẩm -->
                ...
                <div class="content">
                    ...
                    <img src="https://file.hstatic.net/1000061481/collection/untitled-1-01_874d57ddc09d4e3ca35f30a33fcb73ea.jpg" alt="Giày cỏ tự nhiên">
                    </div>
    
                    <!-- Giới thiệu mô tả -->
                    <div class="product-description">
                        <h2>GIÀY BÓNG ĐÁ TRẺ EM</h2>
                        <p>
                    ...
                    <div class="product-list">
                        <?php
                            $sql = "SELECT * FROM products WHERE shoe_type = 'Trẻ Em'"; // Lấy tất cả sản phẩm có shoe_type là trẻ em
                            $result = mysqli_query($conn, $sql);
                            if (mysqli_num_rows($result) > 0):
                                while ($row = mysqli_fetch_assoc($result)): ?>
                                    <div class="mustbuy-item">
