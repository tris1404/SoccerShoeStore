...
// Đảm bảo lọc sản phẩm theo Giày Trẻ Em
$shoeType = 'Trẻ Em';
        ...
        <div class="maincontent">
            ...
            <div class="content">
                <div class="product-intro">
                    <img src="https://file.hstatic.net/1000061481/collection/untitled-1-01_874d57ddc09d4e3ca35f30a33fcb73ea.jpg" alt="Giày trẻ em">
                </div>

                <!-- Giới thiệu mô tả -->
                <div class="product-description">
                    <h2>GIÀY BÓNG ĐÁ TRẺ EM - HÀNH TRANG CHO NHỮNG TÀI NĂNG NHÍ</h2>
                    <p>
                        <strong>SOCCER SHOES STORE</strong> tự hào mang đến bộ sưu tập <strong>giày bóng đá trẻ em</strong>, được thiết kế đặc biệt để phù hợp với đôi chân nhỏ bé của các cầu thủ nhí. 
                        Chúng tôi hiểu rằng việc lựa chọn một đôi giày phù hợp không chỉ giúp các bé thoải mái vận động mà còn khơi dậy niềm đam mê bóng đá ngay từ những bước chạy đầu tiên.<br><br>

                        <strong>Đặc điểm nổi bật của giày bóng đá trẻ em:</strong><br>
                        - Size nhỏ từ 28 đến 38, phù hợp với lứa tuổi từ 4 đến 12 tuổi.<br>
                        - Thiết kế nhẹ nhàng, ôm chân, giúp bảo vệ bàn chân non nớt của bé trong mọi hoạt động.<br>
                        - Đế giày chống trơn trượt, đảm bảo an toàn trên sân cỏ nhân tạo hoặc sân trong nhà.<br>
                        - Màu sắc bắt mắt, kiểu dáng năng động, phù hợp với sở thích của trẻ.<br><br>

                        Bộ sưu tập giày trẻ em tại <strong>SOCCER SHOES STORE</strong> bao gồm các sản phẩm từ những thương hiệu uy tín như <strong>NIKE, ADIDAS, PUMA</strong>, 
                        cùng các thương hiệu Việt Nam chất lượng như <strong>KAMITO, ZOCKER</strong>. Chúng tôi cam kết mang đến những sản phẩm an toàn, bền bỉ và giá cả hợp lý để phụ huynh yên tâm lựa chọn cho con em mình.<br><br>

                        Hãy để <strong>SOCCER SHOES STORE</strong> đồng hành cùng các bé trên hành trình chinh phục ước mơ bóng đá!
                    </p>
                </div>
                ...
                <div class="product-list">
                    <?php
                        $sql = "SELECT * FROM products WHERE shoe_type = 'Trẻ Em' LIMIT $offset, $productsPerPage";
                        $result = mysqli_query($conn, $sql);
                        if (mysqli_num_rows($result) > 0):
                            while ($row = mysqli_fetch_assoc($result)): ?>
                                <div class="mustbuy-item">
