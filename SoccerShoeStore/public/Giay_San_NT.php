...
// Đảm bảo lọc sản phẩm theo Sân Nhân Tạo
        ...
        <div class="maincontent">
            ...
            <div class="content">
                ...
                <div class="product-description">
                    <h2>GIÀY SÂN CỎ NHÂN TẠO - HIỆU SUẤT TỐI ƯU CHO MỌI TRẬN ĐẤU</h2>
                    <p>
                        ...
                        Với đinh giày TF (Turf), những đôi giày này mang lại độ bám vượt trội, giúp bạn di chuyển linh hoạt và tự tin trong từng pha bóng. 
                ...
                <div class="product-list">
                    <?php
                        $sql = "SELECT * FROM products WHERE shoe_type = 'Sân Nhân Tạo' LIMIT $offset, $productsPerPage";
                        $result = mysqli_query($conn, $sql);
                        if (mysqli_num_rows($result) > 0):
                            while ($row = mysqli_fetch_assoc($result)): ?>
                                <div class="mustbuy-item">
