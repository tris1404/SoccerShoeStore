...
// Đảm bảo lọc sản phẩm Hàng Mới Về
$productType = 'new';
        ...
        <div class="maincontent">
            ...
            <div class="content">
                ...
                <div class="product-description">
                    <h2>HÀNG MỚI VỀ - CẬP NHẬT XU HƯỚNG GIÀY BÓNG ĐÁ MỚI NHẤT</h2>
                    <p>
                        <strong>SOCCER SHOES STORE</strong> luôn đi đầu trong việc cập nhật những mẫu <strong>giày bóng đá mới nhất</strong>, mang đến cho bạn cơ hội sở hữu những sản phẩm hot nhất trên thị trường. 
                        Bộ sưu tập <strong>Hàng Mới Về</strong> của chúng tôi bao gồm các mẫu giày vừa ra mắt từ những thương hiệu hàng đầu, đảm bảo bạn luôn dẫn đầu xu hướng.<br><br>

                        <strong>Đặc điểm nổi bật của các mẫu giày mới:</strong><br>
                        - Công nghệ tiên tiến, cải tiến hiệu suất thi đấu trên mọi bề mặt sân.<br>
                        - Thiết kế hiện đại, thời thượng, phù hợp với phong cách của các cầu thủ trẻ.<br>
                        - Chất liệu cao cấp, bền bỉ, mang lại cảm giác thoải mái và chắc chắn trong từng bước chạy.<br><br>

                        Bộ sưu tập mới tại <strong>SOCCER SHOES STORE</strong> bao gồm các sản phẩm từ những thương hiệu hàng đầu thế giới như <strong>NIKE, ADIDAS, PUMA, MIZUNO</strong>. 
                        Dù bạn chơi trên sân cỏ tự nhiên, sân cỏ nhân tạo hay sân trong nhà, chúng tôi đều có những mẫu giày mới phù hợp để giúp bạn tỏa sáng trên sân.<br><br>

                        Đừng bỏ lỡ cơ hội sở hữu những đôi giày mới nhất tại <strong>SOCCER SHOES STORE</strong> – hãy khám phá ngay hôm nay!
                    </p>
                </div>
                ...
                <div class="product-list">
                    <?php
                        $sql = "SELECT * FROM products WHERE product_type = 'new' LIMIT $offset, $productsPerPage";
                        $result = mysqli_query($conn, $sql);
                        if (mysqli_num_rows($result) > 0):
                            while ($row = mysqli_fetch_assoc($result)): ?>
                                <div class="mustbuy-item">
